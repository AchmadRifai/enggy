package project.skripsi.enggy.fragment;
...
import project.skripsi.enggy.R;
import project.skripsi.enggy.activity.MapActivity;
import project.skripsi.enggy.activity.PoiDetailActivity;
import project.skripsi.enggy.adapter.PoiListAdapter;
import project.skripsi.enggy.adapter.SearchSuggestionAdapter;
import project.skripsi.enggy.content.PoiSearchRecentSuggestionsProvider;
import project.skripsi.enggy.database.DatabaseCallListener;
import project.skripsi.enggy.database.DatabaseCallManager;
import project.skripsi.enggy.database.DatabaseCallTask;
import project.skripsi.enggy.database.data.Data;
import project.skripsi.enggy.database.model.PoiModel;
import project.skripsi.enggy.database.query.PoiReadAllQuery;
import project.skripsi.enggy.database.query.PoiReadByCategoryQuery;
import project.skripsi.enggy.database.query.PoiReadFavoritesQuery;
import project.skripsi.enggy.database.query.PoiSearchQuery;
import project.skripsi.enggy.database.query.Query;
import project.skripsi.enggy.dialog.AboutDialogFragment;
import project.skripsi.enggy.geolocation.Geolocation;
import project.skripsi.enggy.geolocation.GeolocationListener;
import project.skripsi.enggy.listener.OnSearchListener;
import project.skripsi.enggy.utility.LocationUtility;
import project.skripsi.enggy.utility.Logcat;
import project.skripsi.enggy.view.GridSpacingItemDecoration;
import project.skripsi.enggy.view.ViewState;
